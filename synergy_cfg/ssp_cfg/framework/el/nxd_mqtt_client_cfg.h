...
#define NXD_MQTT_MAX_MESSAGE_LENGTH (2048)

/* The MQTT timer rate */
#define NXD_MQTT_KEEPALIVE_TIMER_RATE (60 * TX_TIMER_TICKS_PER_SECOND)

/* Time MQTT client waits for PINGRESP from the broker for after it sends out MQTT PINGREQ */
#define NXD_MQTT_PING_TIMEOUT_DELAY (60 * TX_TIMER_TICKS_PER_SECOND)
