...
C_SRCS += \
../port/port/portevent.c \
../port/port/portother.c \
../port/port/portserial.c \
../port/port/porttimer.c 

OBJS += \
./port/port/portevent.o \
./port/port/portother.o \
./port/port/portserial.o \
./port/port/porttimer.o 

C_DEPS += \
./port/port/portevent.d \
./port/port/portother.d \
./port/port/portserial.d \
./port/port/porttimer.d 


# Each subdirectory must supply rules for building sources it contributes
port/port/%.o: ../port/port/%.c
	@echo 'Building file: $<'
