...
#define SF_THREAD_MONITOR_API_VERSION_MAJOR (1U)
#define SF_THREAD_MONITOR_API_VERSION_MINOR (6U)
...
/** Thread monitor control block.  Allocate an instance specific control block to pass into the
 * thread monitor API calls.
 * @par Implemented as
