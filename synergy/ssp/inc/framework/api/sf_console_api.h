...
#define SF_CONSOLE_API_VERSION_MAJOR   (1U)
#define SF_CONSOLE_API_VERSION_MINOR   (7U)
...
Typedef definitions
***********************************************************************************************************************/
/** Console framework control block.  Allocate an instance specific control block to pass into the
 * console framework API calls.
 * @par Implemented as
...
typedef struct st_sf_console_menu
{
...
typedef struct st_sf_console_api
{
     ...
     *
     * @param[in]   p_ctrl     Pointer to device control block initialized in Open call for UART driver.
     * @param[in]   p_menu     Set to NULL to stay on current menu maintained by the console framework.  To change
     *                         menus, pass a pointer to the new menu.
