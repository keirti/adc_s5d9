...
UINT  ux_hcd_synergy_bulk_int_td_add(UX_HCD_SYNERGY *hcd_synergy, UX_SYNERGY_ED *ed)
{
    ...
    ux_hcd_synergy_register_clear(hcd_synergy, UX_SYNERGY_HC_BEMPSTS, (USHORT)(1UL << ed -> ux_synergy_pipe_index));
    ux_hcd_synergy_register_clear(hcd_synergy, UX_SYNERGY_HC_BRDYSTS, (USHORT)(1UL << ed -> ux_synergy_pipe_index));
