...
/***********************************************************************************************************************
 * Copyright [2017-2018] Renesas Electronics Corporation and/or its licensors. All Rights Reserved.
 * 
...
#define NX_CRYPTO_AES_OUTPUT_BUFFER_SIZE 2048
#endif /* NX_CRYPTO_AES_OUTPUT_BUFFER_SIZE */
#define NX_CRYPTO_AES_INPUT_BUFFER_SIZE NX_CRYPTO_AES_OUTPUT_BUFFER_SIZE
...
UINT nx_aes_ctx_cbc_decrypt_sce(NX_CRYPTO_AES_SCE *aes_ptr, UCHAR *iv, ULONG length, UCHAR *input, UCHAR *output);
UINT nx_aes_ctx_cbc_encrypt_sce(NX_CRYPTO_AES_SCE *aes_ptr, UCHAR *iv, ULONG length, UCHAR *input, UCHAR *output);
UINT nx_aes_key_set_sce(NX_CRYPTO_AES_SCE *aes_ptr, UINT operation_type, UCHAR *key, UCHAR key_size);

UINT _nx_crypto_aes_gcm_encrypt_sce(aes_instance_t *crypto_ptr,
                                    ...
                                    UCHAR *output,
                                    UCHAR *tag);
UINT _nx_crypto_aes_gcm_encrypt_sce_be(aes_instance_t *crypto_ptr,
                                        NX_CRYPTO_AES_SCE *ctx,
                                        UCHAR *input,
                                        ULONG input_length_in_byte,
                                        UCHAR *iv_ptr,
                                        UCHAR *output,
                                        UCHAR *tag);
UINT _nx_crypto_aes_gcm_decrypt_sce(aes_instance_t *crypto_ptr,
                                    NX_CRYPTO_AES_SCE *ctx,
                                    UCHAR *input,
                                    ULONG input_length_in_byte,
                                    UCHAR *iv_ptr,
                                    UCHAR *output,
                                    UCHAR *tag);
UINT _nx_crypto_aes_gcm_decrypt_sce_be(aes_instance_t *crypto_ptr,
                                        NX_CRYPTO_AES_SCE *ctx,
                                        UCHAR *input,
                                        ULONG input_length_in_byte,
                                        UCHAR *iv_ptr,
